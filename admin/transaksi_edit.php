						...
						<table class="table table-bordered table-striped">
							...
							<div class="form-group alert-info">
								...
								<select class="form-control" name="status" required="required">
									...
									<option <?php if($t['transaksi_status']=="1"){echo "selected='selected'";} ?> value="2">DI CUCI</option>

									<option <?php if($t['transaksi_status']=="2"){echo "selected='selected'";} ?> value="2">PROSES</option>
