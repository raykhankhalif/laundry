...
<div class ="container">
    <div class="alert alert-info text-center">
        <h4 style="margin-bottom: 0px;"><b>Selamat Datang di Sistem Informasi Laundry</b></h4>
    </div>
    <div class="panel>
                ...
                <div class="panel panel-warning">
                    <div class="panel-heading">
                        <h1>
                            ...
                            <span class="pull-right">
                                <?php
                                    $proses = mysqli_query($koneksi,"select * from transaksi where
                                    transaksi_status ='0'");
            ...
            <table class="table table-bordered table-striped">
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            <td><?php echo $no++; ?></td>
                            <td>INVOICE-</INVOICE-><?php echo $d['transaksi_id']; ?></td>
